...
main()
    {
    uint64_t STREAM_ARRAY_SIZE = 10000000;
    ...
    STREAM_TYPE * a = reinterpret_cast<STREAM_TYPE *>( (STREAM_ARRAY_SIZE+OFFSET) * sizeof(STREAM_TYPE) ); 
    STREAM_TYPE * b = reinterpret_cast<STREAM_TYPE *>( (STREAM_ARRAY_SIZE+OFFSET) * sizeof(STREAM_TYPE) ); 
    STREAM_TYPE * c = reinterpret_cast<STREAM_TYPE *>( (STREAM_ARRAY_SIZE+OFFSET) * sizeof(STREAM_TYPE) ); 
